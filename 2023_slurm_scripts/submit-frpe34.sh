...
#SBATCH --job-name=FST-Pop16   	#Name of the job
...
--output /scratch/frpe222/Fst/P16.fst \
--min-count 2 --min-coverage 20 --max-coverage 2% --pool-size 39:42:43:41:48:46 \
...
perl /usr/local/popoolation2_1201/fst-sliding.pl \
--input /scratch/frpe222/PileupSync/Pop16_java.sync \
--output /scratch/frpe222/Fst/P16_karlsson.fst \
--min-count 2 --min-coverage 20 --max-coverage 2% --pool-size 39:42:43:41:48:46 \
