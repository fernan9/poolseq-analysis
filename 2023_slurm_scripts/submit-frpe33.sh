...
#SBATCH --job-name=Fish-PopAD				  	#Name of the job
...
--output /scratch/frpe222/Fisher/PopAD.fet \
...
perl /usr/local/popoolation2_1201/fisher-test.pl \
--input /scratch/frpe222/PileupSync/PopAD_java.sync \
--output /scratch/frpe222/Fisher/PopAD_w1000_geom.fet \
...
perl /usr/local/popoolation2_1201/fisher-test.pl \
--input /scratch/frpe222/PileupSync/PopAD_java.sync \
--output /scratch/frpe222/Fisher/PopAD_w1000_mult.fet \
--min-count 2 --min-coverage 20 --max-coverage 2% --min-covered-fraction 0.2 \
